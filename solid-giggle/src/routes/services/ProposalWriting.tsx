    ...
    <>
      ...
      <Section>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-sm font-bold uppercase tracking-wider text-blue-600">Proposal Writing Services</p>
            ...
            <div className="lg:pl-8">
                <Card className="p-8" hover>
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-slate-900 text-lg">The GSA Managers Difference</h3>
            ...
            {shipleyPrinciples.map((item, idx) => (
              ...
              >
                <Card className="p-6 h-full text-center" hover>
                    ...
                    <h3 className="mt-4 font-bold text-lg text-slate-900">{item.principle}</h3>
                    ...
                    <div className="mt-6 pt-6 border-t border-slate-200">
                        <div className="flex justify-between items-baseline">
                            <div>
                                ...
                                <div className="font-display text-3xl font-bold text-slate-900">{service.price}</div>
                            </div>
                            <div>
      ...
      {/* ===== CTA ===== */}
      <Section title="Have an RFP on Your Desk?" kicker="Let's Win It Together" dark>
